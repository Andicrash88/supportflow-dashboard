  ...
  return (
    <header className="flex flex-col gap-4 rounded-[28px] border border-[#D0D7DE] bg-white px-5 py-4 shadow-panel dark:border-[#30363D] dark:bg-[#161B22] sm:flex-row sm:items-center sm:justify-between">
      <label className="sr-only" htmlFor="topbar-search">
        Search tickets, tasks, or teammates
      </label>
      <div className="flex w-full max-w-xl items-center gap-3 rounded-2xl border border-[#D0D7DE] bg-slate-50 px-4 py-3 transition-colors hover:bg-white dark:border-[#30363D] dark:bg-[#0B0E14] dark:hover:bg-[#161B22]">
      ...
      <div className="flex w-full flex-wrap items-center gap-3 sm:w-auto sm:justify-end">
        ...
        <div className="flex min-w-0 max-w-full flex-1 items-center gap-3 rounded-2xl border border-[#D0D7DE] bg-white px-3 py-2 dark:border-[#30363D] dark:bg-[#161B22] sm:flex-none">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold text-slate-900 dark:text-[#F0F6FC]">{user.name}</p>
            <div className="mt-1 flex items-center gap-2">
              <p className="truncate text-xs text-slate-500 dark:text-[#8B949E]">{user.role}</p>
