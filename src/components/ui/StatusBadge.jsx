...
const badgeStyles = {
  status: {
    ...
    Resolved: "bg-emerald-50 text-emerald-700 ring-emerald-200 dark:bg-[#238636]/12 dark:text-[#3FB950] dark:ring-[#238636]/30",
    Completed: "bg-emerald-50 text-emerald-700 ring-emerald-200 dark:bg-[#238636]/12 dark:text-[#3FB950] dark:ring-[#238636]/30",
    ...
    online: "bg-emerald-50 text-emerald-700 ring-emerald-200 dark:bg-[#238636]/12 dark:text-[#3FB950] dark:ring-[#238636]/30",
  },
  priority: {
    ...
    Low: "bg-emerald-50 text-emerald-700 ring-emerald-200 dark:bg-[#238636]/12 dark:text-[#3FB950] dark:ring-[#238636]/30",
  },
};
...
export function StatusBadge({ value, variant = "status" }) {
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-full px-2.5 py-1 text-xs font-medium ring-1 ring-inset dark:bg-opacity-20",
